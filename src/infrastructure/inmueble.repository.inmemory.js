...
exports.InMemoryInmuebleRepository = void 0;
...
class InMemoryInmuebleRepository {
    data;
    constructor(data = INMUEBLES_DEMO) {
        this.data = data;
    }
    findById(id) {
...
exports.InMemoryInmuebleRepository = InMemoryInmuebleRepository;
//# sourceMappingURL=inmueble.repository.inmemory.js.map